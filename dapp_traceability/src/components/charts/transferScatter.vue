...
export default {
  ...
  methods: {
    async initChart () {
      const startBlockList = [34, 48, 55, 62, 70, 77, 84, 91, 98, 103, 110, 117, 122, 127, 134]
      const endBlockList = [46, 53, 60, 68, 75, 82, 89, 96, 101, 108, 115, 120, 125, 132, 137]
      const orderData = await this.orderAnalyser(startBlockList, endBlockList)
      const data = orderData.flatMap(o => o.transferGasByLength)
